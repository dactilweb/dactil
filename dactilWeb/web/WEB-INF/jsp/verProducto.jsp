                ...
                <div class="row">
                    ...
                    <div class="col-sm">
                        <div class="anadirCarrito">
                            ...
                            <c:choose>
                                <c:when test="${productos.cantidad_producto<=0}">
                                   <div class="alert alert-danger">Este producto está fuera de stock, puede solicitarlo a través de <a href="" class="">info@dactil.com</a><br></div>
                                </c:when>
                                <c:otherwise>
                                    <form:form modelAttribute="lineaFactura" action="carrito" method="POST">
                                        ...
                                        <c:choose>
                                <c:when test="${productos.cantidad_producto<5 && productos.cantidad_producto>0}">
                                   
                                  <div class="alert alert-warning">¡Alerta, últimas unidades!</div>
                                </c:when>
                                <c:otherwise>
