    ...
    <body>
        ...
        <div class="contenido">
            <div class="contenido2">
                <c:choose>
                    <c:when test="${fn:length(listaPedidos)>0}">
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Pedido Nº${pedidos.id_factura} / ${pedidos.fecha_factura}</h5>
                    ...
                    <c:otherwise>
                        ...
                        <div class="alert alert-warning alert-dismissible fade show" role="alert">
                            Tendrás disponible el seguimiento de los pedidos cuando hayas hecho al menos <strong>uno</strong>.
